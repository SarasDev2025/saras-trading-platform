-- =====================================================
-- EXACT SCHEMA MATCHING SCRIPT
-- Uses your exact table structure
-- =====================================================

-- First test a simple insert
SELECT 'Starting data insertion...' as status;

-- Insert assets using your exact schema
-- Note: asset_type must be 'stock' (lowercase per your constraint)
-- =====================================================
...
-- Check assets inserted
SELECT 'Assets inserted: ' || COUNT(*) as status FROM assets WHERE symbol IN ('TCS', 'INFY', 'HDFCBANK', 'RELIANCE');

-- =====================================================
-- COMPLETE EXACT SCHEMA MATCHING SCRIPT
-- Uses your exact table structure
-- =====================================================
...
-- Insert smallcases using your exact schema
-- Note: risk_level must be 'low', 'medium', or 'high' (lowercase)
-- Note: created_by is UUID, we'll leave it NULL for now
-- =====================================================
...
-- Check smallcases inserted
SELECT 'Smallcases inserted: ' || COUNT(*) as status FROM smallcases;
