...
CREATE TABLE public.assets (
    ...
    CONSTRAINT assets_asset_type_check CHECK (((asset_type)::text = ANY ((ARRAY['stock'::character varying, 'etf'::character varying, 'crypto'::character varying, 'forex'::character varying, 'commodity'::character varying, 'bond'::character varying])::text[]))),
