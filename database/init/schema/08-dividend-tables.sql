...
-- 1. dividend_bulk_orders (parent - external deps only)
-- 2. dividend_declarations (parent - external deps only)
-- 3. user_drip_preferences (external deps only)
-- 4. user_position_snapshots (depends on dividend_declarations)
-- 5. user_dividend_payments (depends on user_position_snapshots)
-- 6. drip_transactions (depends on user_dividend_payments)
-- 7. drip_bulk_order_allocations (depends on drip_transactions)
--
