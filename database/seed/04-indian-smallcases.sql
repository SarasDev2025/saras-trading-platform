...
(uuid_generate_v4(), 'Banking & NBFC Focus', 'Concentrated portfolio of top Indian banking and financial services companies with strong fundamentals and market leadership', 'Sector', 'India', 'QUARTERLY', 'MEDIUM', 15000, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'IT Export Leaders', 'Premier Indian IT services companies with global presence and consistent dollar revenue growth', 'Sector', 'India', 'QUARTERLY', 'MEDIUM', 20000, TRUE, NOW()),
(uuid_generate_v4(), 'Consumer Staples Basket', 'Defensive portfolio of leading FMCG and consumer goods companies with pricing power and brand moats', 'Sector', 'India', 'QUARTERLY', 'LOW', 12000, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Dividend Aristocrats', 'High dividend yielding PSU and infrastructure stocks for steady passive income generation', 'Income', 'India', 'QUARTERLY', 'LOW', 10000, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Growth Momentum Portfolio', 'High-growth companies across sectors with strong earnings momentum and market leadership', 'Growth', 'India', 'QUARTERLY', 'HIGH', 25000, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Pharma & Healthcare Leaders', 'Top pharmaceutical companies with strong domestic and export presence', 'Sector', 'India', 'QUARTERLY', 'MEDIUM', 15000, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Infrastructure Build India', 'Companies benefiting from infrastructure capex cycle and government spending', 'Thematic', 'India', 'QUARTERLY', 'HIGH', 18000, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Auto & Ancillaries', 'Leading automobile manufacturers and auto component companies poised for EV transition', 'Sector', 'India', 'QUARTERLY', 'HIGH', 15000, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Metals & Mining Play', 'Cyclical portfolio of metal producers benefiting from commodity upcycles', 'Sector', 'India', 'QUARTERLY', 'HIGH', 12000, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'All Weather Balanced', 'Diversified portfolio across sectors for all market conditions with balanced risk-reward', 'Diversified', 'India', 'QUARTERLY', 'MEDIUM', 20000, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Nifty 50 Core', 'Blue-chip portfolio tracking large-cap benchmark constituents for long-term wealth creation', 'Index', 'India', 'QUARTERLY', 'LOW', 15000, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'ESG & Quality Leaders', 'High-quality companies with strong ESG scores and sustainable business practices', 'Thematic', 'India', 'QUARTERLY', 'MEDIUM', 20000, TRUE, NOW(), NOW());
