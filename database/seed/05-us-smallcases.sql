...
INSERT INTO smallcases (id, name, description, category, region, rebalancing_frequency, risk_level, min_investment_amount, is_active, created_at, updated_at) VALUES
(uuid_generate_v4(), 'FAANG Leaders', 'Classic FAANG stocks representing the biggest tech giants that have dominated the market. Includes Apple, Amazon, Netflix, Google, and Meta (formerly Facebook).', 'Sector', 'US', 'QUARTERLY', 'MEDIUM', 2500.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Magnificent 7 Tech', 'The magnificent seven technology stocks that have driven market returns. Includes the most influential tech companies with AI and cloud capabilities.', 'Sector', 'US', 'QUARTERLY', 'HIGH', 3000.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'S&P 500 Core', 'Diversified blue-chip portfolio representing the backbone of the S&P 500 index. Balanced exposure across sectors for steady long-term growth.', 'Diversified', 'US', 'QUARTERLY', 'MEDIUM', 2000.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Banking & Financials', 'Leading US banks and financial institutions. Exposure to the core of American financial services with established market leaders.', 'Sector', 'US', 'QUARTERLY', 'MEDIUM', 1500.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Healthcare Innovation', 'Top pharmaceutical and healthcare companies driving medical innovation. Mix of established pharma giants and biotech leaders.', 'Sector', 'US', 'QUARTERLY', 'MEDIUM', 2000.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Dividend Aristocrats US', 'Reliable dividend-paying companies with decades of consistent dividend growth. Focus on stability and passive income generation.', 'Income', 'US', 'QUARTERLY', 'LOW', 1500.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'EV & Clean Energy', 'Electric vehicle manufacturers and renewable energy leaders. High-growth exposure to the transition to sustainable energy.', 'Thematic', 'US', 'QUARTERLY', 'HIGH', 2500.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Semiconductors & AI', 'Chip manufacturers and AI hardware leaders powering the next generation of computing. Critical infrastructure for AI revolution.', 'Sector', 'US', 'QUARTERLY', 'HIGH', 3000.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Consumer Discretionary', 'Leading consumer brands and retailers benefiting from consumer spending trends. Exposure to e-commerce, retail, and lifestyle brands.', 'Sector', 'US', 'QUARTERLY', 'MEDIUM', 2000.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Cloud & SaaS', 'Cloud computing and software-as-a-service leaders. Pure-play exposure to the digital transformation and enterprise software.', 'Sector', 'US', 'QUARTERLY', 'HIGH', 2500.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'Energy & Oil', 'Traditional energy giants and oil exploration companies. Exposure to energy sector with focus on established producers.', 'Sector', 'US', 'QUARTERLY', 'MEDIUM', 1500.00, TRUE, NOW(), NOW()),
(uuid_generate_v4(), 'All Weather US Portfolio', 'Diversified portfolio designed to perform across all market conditions. Balanced allocation across sectors, market caps, and risk profiles.', 'Diversified', 'US', 'QUARTERLY', 'LOW', 5000.00, TRUE, NOW(), NOW());
