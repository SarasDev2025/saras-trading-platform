...
export function RecentTrades() {
  ...
  const { data: trades, isLoading } = useQuery<Trade[]>({
    queryKey: ["/api/portfolios", "portfolio-id", "trades"],
          ...
          <>
                      ...
                      <tr key={trade.id} className="border-b border-[var(--carbon-gray-80)]">
                        ...
                        <td className="py-3">
                          <Badge 
                            ...
                            className={
                              trade.side === 'BUY' 
                                ? 'bg-[var(--success-green)] bg-opacity-20 text-[var(--success-green)] hover:bg-[var(--success-green)] hover:bg-opacity-30'
                                : 'bg-[var(--danger-red)] bg-opacity-20 text-[var(--danger-red)] hover:bg-[var(--danger-red)] hover:bg-opacity-30'
                            }
                          >
                            {trade.side}
                          </Badge>
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <div className="flex items-center space-x-2">
                <Button variant="outline" size="sm" className="bg-[var(--carbon-gray-80)] border-[var(--carbon-gray-70)] text-white hover:bg-[var(--carbon-gray-70)]">
                  Previous
                </Button>
